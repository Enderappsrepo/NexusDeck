...
export function BrowseFilterSheet({
  ...
  const { sheetRef, sheetProps } = useSheetA11y(open, onClose, "Browse filters");
  ...
  return (
    <div className="cc-sheet-backdrop" onClick={onClose}>
      <div ref={sheetRef} className="cc-sheet cc-filter-sheet" {...sheetProps} onClick={(e) => e.stopPropagation()}>
        <div className="mb-4 flex items-center justify-between gap-3">
          <p className="cc-section-label mb-0">Filters</p>
        ...
        <div className="mt-5 flex gap-2">
          <button type="button" className="cc-btn-secondary flex-1" onClick={onClose}>
            Cancel
          </button>
          <button type="button" className="cc-btn flex-1" onClick={handleApply}>
            Apply filters
          </button>
        </div>
      </div>
